set :application, "stylesclub" # change me
set :user,        'deploy'
set :password,    ''

set :scm,         "git"
set :branch,      "develop"
set :repository,  "git@internal.mo-collective.com:Stylesclub-App.git"
...
role :app,        "app2.mo-stud.io"
role :web,        "app2.mo-stud.io"
role :db,         "app2.mo-stud.io", :primary => true
